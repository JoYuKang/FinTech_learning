...
var clientId = "5j8PaIJhDuAubKATzNPASDp0FC7rvObeNyHw28fg" // 클라이언트 아이디 변경
var clientSecret = "V9Jf9xvqKKyGP2MPnTnB00bf8F7EackjsI4u4zjN" // 클라이언트 시크릿 변경
...
app.post('/balance',auth, function(req, res){
  ...
  var transId = "T991671650U" + countnum; //이용기과번호 본인것 입력
  var userId = req.decoded.userId;
  var userSelectSql = "SELECT * FROM user WHERE id = ?";
  connection.query(userSelectSql, [userId], function(err, results){
    if(err){throw err}
